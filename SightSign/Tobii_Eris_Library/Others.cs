...
namespace Tobii_Eris_Library
{
    ...
    public class TextBlockControlXYandWidthHeight : IsControlXYandWidthHeight
    {
        public override double Width()
        {
            if (Self() is TextBlock)
            {
                return (Self() as TextBlock).ActualWidth;
            }
        ...
        public override double Height()
        {
            if (Self() is TextBlock)
            {
                return (Self() as TextBlock).ActualHeight;
            }

            return base.Width();
        }

        public TextBlockControlXYandWidthHeight(UIElement self) : base(self) { }
    }
