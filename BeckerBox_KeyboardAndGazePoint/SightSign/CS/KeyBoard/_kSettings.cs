...
namespace BeckerBox
{
    ...
    {
        //******   For "GazingOn"   ************
        private Brush btnColor = GetValueFromStyle(typeof(Button), BackgroundProperty) as Brush;
        private Control GazingOnObj = null;
        private object _lock = new object();
        //**************************************

        private ObservableCollection<Button> UtinityBtns = null;
        ...
        public static List<ControlsXYandWidthHeight> tmpBtnCollection { get; private set; }
